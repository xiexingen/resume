  ...
  "projects": [
    {
      ...
      "descriptions": [
        {
          "header": "产品介绍",
          "contents": ["大禹平台是集安全开发运行框架、安全大数据平台、安全分析应用平台三位一体的安全中台,整合集团安全产品、服务、数据,为公司新一代基于实战攻防的态势感知(监管、运营、攻防)以及数据安全、工业安全、API安全等产线和重点项目提供平台级支撑，并提供配套的内置安全能力;其核心能力包括数据接入、数据治理、云地协同、联合分析系统、事件分析与管理、安全设备接入..."]
        },
        {
          "header": "主要职责",

  ...
  return (
    <Card bordered={false}>
      <Typography>
        ...
        <Paragraph>
          写过业务页面、搭过基础框架、做过项目管理、也造过前端组件轮子，写过的组件如：拖拽滑块验证码、手写签名、基于 lodop 的 web 打印、基于UEditor 形式的表单设计器、基于 TinyMCE 的关键词高亮、自定义 json 形式的表单设计器、基于 signalr 的推送、加密传输、token 失效自动刷新、玩过 WPF...
        </Paragraph>
        <Paragraph>
